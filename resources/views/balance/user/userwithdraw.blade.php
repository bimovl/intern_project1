...
@if (session('status'))
        ...
        <div class="card justify-content">
            <div class="card-header">
                <h5 class="title text-center"> Withdraw Cash </h5><hr>
              </div>
            ...
            <form method="post" action="{{route('balance.storecash')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-success" onclick="return confirm('Are you sure you want to withdraw your balance?')" >
                                    Withdraw
                                </button>
                            </div>
                        </div>
