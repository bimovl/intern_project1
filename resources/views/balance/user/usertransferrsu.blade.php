...
@if (session('status'))
        ...
        <div class="card justify-content">
            <div class="card-header">
                <h5 class="title text-center"> Transfer RSU</h5><hr>
              </div>
            ...
            <form method="post" action="{{route('balance.storersu')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <input type="hidden" name="user_id" value="{{$item['user_id']}}">
                                <input id="saldo_awal" type="hidden" onkeyup="sum();" class="disable form-control @error('saldo_awal') is-invalid @enderror" name="saldo_awal" value="{{$item['saldo_akhir']}}" required autocomplete="saldo_awal">
                                @error('saldo_awal')
                        ...
                        <div class="col-md-6">
                            <select name="penerima" id="penerima" class="form-select @error('penerima') is-invalid @enderror" >
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="btn btn-success" onclick="return confirm('Are you sure you want to transfer your RSU balance?')" >
                                    Transfer
                                </button>
                            </div>
                        </div>
