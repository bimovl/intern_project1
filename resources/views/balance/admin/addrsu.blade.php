        ...
        <div class="card justify-content">
            ...
            <form method="post" action="{{route('balance.storersu')}}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row" hidden="form-group row">
                            <label for="saldo_awal" class="col-md-4 col-form-label text-md-right">Beginning Balance :</label>
                        ...
                        <div class="form-group row">
                            <label for="saldo_akhir" class="col-md-4 col-form-label text-md-right">Total Unit Balance :</label>
                            <div class="col-md-6">
