...
@if (session('status'))
        ...
        <div class="card justify-content">
            <div class="card-header">
                <h5 class="title text-center"> Withdraw rsu {{ $rsu->user->name }} {{ $rsu->user->last_name }}</h5><hr>
              </div>
              
            <div class="card-body">
            <form method="post" action="{{route('balance.updatewithdrawrsu')}}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row" hidden="form-group row">
                            ...
                            <div class="col-md-6">
                            <input  name="id" value="{{$rsu['id']}}">
                            <input  name="user_id" value="{{$rsu['user_id']}}">
                                <input id="saldo_awal" type="hidden" onkeyup="sum();" class="form-control @error('saldo_awal') is-invalid @enderror" name="saldo_awal" value="{{$rsu['saldo_awal']}}">
                                @error('saldo_awal')
                        ...
                        <div class="form-group row">
                            ...
                            <input type="hidden" name="transaksi" value="withdraw">
                                <input id="jumlah_transaksi" type="number" onkeyup="sum();" class="form-control @error('jumlah_transaksi') is-invalid @enderror" name="jumlah_transaksi" value="{{$rsu['jumlah_transaksi']}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="saldo_akhir" type="number" onkeyup="sum();" class="form-control @error('saldo_akhir') is-invalid @enderror" name="saldo_akhir" value="{{$rsu['saldo_akhir']}}" readonly>
                                @error('saldo_akhir')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
